...
public class YMTGetDeviceName {
    ...
    enum DeviceCode: String {
        ...
        var deviceName: String {
            switch self {
            // MARK: Simulator
            case .i386, .x86_64, .arm64: "Simulator"

            // MARK: iPod
            case .iPod1_1: "iPod Touch 1st Generation"
            case .iPod2_1: "iPod Touch 2nd Generation"
            case .iPod3_1: "iPod Touch 3rd Generation"
            case .iPod4_1: "iPod Touch 4th Generation"
            case .iPod5_1: "iPod Touch 5th Generation"
            case .iPod7_1: "iPod Touch 6th Generation"
            case .iPod9_1: "iPod Touch 7th Generation"

            // MARK: iPhone
            case .iPhone1_1: "iPhone 2G"
            case .iPhone1_2: "iPhone 3G"
            case .iPhone2_1: "iPhone 3GS"
            case .iPhone3_1, .iPhone3_2, .iPhone3_3: "iPhone4"
            ...
            case .iPhone8_4: "iPhone SE 1st Generation"
            ...
            case .iPhone14_6: "iPhone SE 3rd Generation"
            ...
            case .iPhone17_1: "iPhone 16 Pro"
            case .iPhone17_2: "iPhone 16 Pro Max"
            case .iPhone17_3: "iPhone 16"
            case .iPhone17_4: "iPhone 16 Plus"
            case .iPhone17_5: "iPhone 16e"
            case .iPhone18_1: "iPhone 17 Pro"
            case .iPhone18_2: "iPhone 17 Pro Max"
            case .iPhone18_3: "iPhone 17"
            case .iPhone18_4: "iPhone Air"

            // MARK: iPad
            case .iPad1_1: "iPad 1"
            case .iPad2_1, .iPad2_2, .iPad2_3, .iPad2_4: "iPad 2"
            case .iPad2_5, .iPad2_6, .iPad2_7: "iPad mini 1st Generation"
            case .iPad3_1, .iPad3_2, .iPad3_3: "iPad 3"
            case .iPad3_4, .iPad3_5, .iPad3_6: "iPad 4"
            case .iPad4_1, .iPad4_2, .iPad4_3: "iPad Air 1st Generation"
            case .iPad4_4, .iPad4_5, .iPad4_6: "iPad mini 2"
            case .iPad4_7, .iPad4_8, .iPad4_9: "iPad mini 3"
            case .iPad5_1, .iPad5_2: "iPad mini 4"
            case .iPad5_3, .iPad5_4: "iPad Air 2"
            case .iPad6_3, .iPad6_4: "iPad Pro 9.7-inch"
            case .iPad6_7, .iPad6_8: "iPad Pro 12.9-inch"
            case .iPad6_11, .iPad6_12: "iPad 5th Generation"
            case .iPad7_1, .iPad7_2: "iPad Pro 12.9-inch 2nd Generation"
            case .iPad7_3, .iPad7_4: "iPad Pro 10.5-inch"
            case .iPad7_5, .iPad7_6: "iPad 6th Generation"
            case .iPad7_11, .iPad7_12: "iPad 7th Generation"
            case .iPad8_1, .iPad8_2, .iPad8_3, .iPad8_4: "iPad Pro 11-inch"
            case .iPad8_5, .iPad8_6, .iPad8_7, .iPad8_8: "iPad Pro 12.9-inch 3rd Generation"
            case .iPad8_9, .iPad8_10: "iPad Pro 11-inch 2nd Generation"
            case .iPad8_11, .iPad8_12: "iPad Pro 12.9-inch 4th Generation"
            case .iPad11_1, .iPad11_2: "iPad mini 5th Generation"
            case .iPad11_3, .iPad11_4: "iPad Air 3rd Generation"
            case .iPad11_6, .iPad11_7: "iPad 8th Generation"
            case .iPad12_1, .iPad12_2: "iPad 9th generation"
            case .iPad13_1, .iPad13_2: "iPad Air 4th Generation"
            case .iPad13_4, .iPad13_5, .iPad13_6, .iPad13_7: "iPad Pro 11-inch 3rd Generation"
            case .iPad13_8, .iPad13_9, .iPad13_10, .iPad13_11: "iPad Pro 12.9-inch 5th Generation"
            case .iPad13_16, .iPad13_17: "iPad Air 5th Generation"
            case .iPad13_18, .iPad13_19: "iPad 10th Gen"
            case .iPad14_1, .iPad14_2: "iPad mini 6th Generation"
            case .iPad14_3, .iPad14_4: "iPad Pro 11-inch 4th Gen"
            case .iPad14_5, .iPad14_6: "iPad Pro 12.9-inch 6th Gen"
            case .iPad14_8, .iPad14_9: "iPad Air 11-inch M2"
            case .iPad14_10, .iPad14_11: "iPad Air 13-inch M2"
            case .iPad16_3, .iPad16_4: "iPad Pro 11-inch M4"
            case .iPad16_5, .iPad16_6: "iPad Pro 13-inch M4"
            }
        }
    }
